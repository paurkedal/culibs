...
/** Special value for the end position of slicing operations to indicate
 ** slicing to the end. */
 ...
 ** <code>*\a mult_out</code> to the exact operator and return true, else
 ** return false.
 **
 ** \see cuex_is_monoid_nongen
...
/** The identity element of the monoid induced by \a mult.  This is the same
 ** for both unnested or nested cases.*/
 ...
 ** with \a x, for each expression drawn from \a source as the last
 ** argument. */
...
/** Factor number \a i (counting from 0) of the factorisation of \a x with
 ** respect to \a mult.  If \a i is negative it's taken to be relative to just
 ** past the last factor of \a x.
 **
...
/** The monoid of factors \a i inclusive to \a j exclusive of the factorisation
 ** of \a x, considering the operator \a mult.
 **
...
/** Returns a source which provides the factors \a i inclusive to \a j
