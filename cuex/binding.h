 ...
 * subexpression of \a e, and \e S is a \ref cuex_uset_s of the de Bruijn
...
cucon_pmap_t cuex_foldinert_indices(cuex_t e, int max_binding_depth);

cuex_t cuex_foldinert_rebind(cuex_t e, int max_binding_depth);
